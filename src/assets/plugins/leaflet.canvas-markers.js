! function(t) {
	...
	function e(t, n) {
		...
		this._maxEntries = Math.max(4, t || 9), this._minEntries = Math.max(2, Math.ceil(.4 * this
			._maxEntries)), n && this._initFormat(n), this.clear()
	}
	...
	function h(t, n) {
		return t.minX = Math.min(t.minX, n.minX), t.minY = Math.min(t.minY, n.minY), t.maxX = Math.max(t.maxX, n
			.maxX), t.maxY = Math.max(t.maxY, n.maxY), t
	}
	...
	function p(t, n, i, e, r) {
		for (var o, s = [n, i]; s.length;)(i = s.pop()) - (n = s.pop()) <= e || (o = n + Math.ceil((i - n) / e /
			2) * e, a(t, o, n, i, r), s.push(n, o, o, i))
	}
	e.prototype = {
		all: function() {
		...
		search: function(t) {
			...
			if (!d(t, n)) return i;
			for (var e, r, o, s, h = []; n;) {
				for (e = 0, r = n.children.length; e < r; e++) o = n.children[e], d(t, s = n.leaf ? a(
					o) : o) && (n.leaf ? i.push(o) : f(t, s) ? this._all(o, i) : h.push(o));
				n = h.pop()
			}
			return i
		},
		...
		remove: function(t, n) {
			...
			for (var i, a, e, o, s = this.data, h = this.toBBox(t), l = [], c = []; s || l.length;) {
				if (s || (s = l.pop(), a = l[l.length - 1], i = c.pop(), o = !0), s.leaf && -1 !== (e =
						r(t, s.children, n))) return s.children.splice(e, 1), l.push(s), this._condense(
					l), this;
				o || s.leaf || !f(s, h) ? a ? (i++, s = a.children[i], o = !1) : s = null : (l.push(s),
					c.push(i), i = 0, a = s, s = s.children[0])
			}
			return this
		},
		toBBox: function(t) {
		...
		_all: function(t, n) {
			for (var i = []; t;) t.leaf ? n.push.apply(n, t.children) : i.push.apply(i, t.children), t =
				i.pop();
			return n
		},
		_build: function(t, n, i, a) {
			...
			a || (a = Math.ceil(Math.log(r) / Math.log(s)), s = Math.ceil(r / Math.pow(s, a - 1))), (e =
				_([])).leaf = !1, e.height = a;
			var h, l, c, m, u = Math.ceil(r / s),
		...
		_chooseSubtree: function(t, n, i, a) {
			for (var e, r, o, s, h, l, c, u, f, d; a.push(n), !n.leaf && a.length - 1 !== i;) {
				for (c = u = 1 / 0, e = 0, r = n.children.length; e < r; e++) h = m(o = n.children[e]),
					f = t, d = o, (l = (Math.max(d.maxX, f.maxX) - Math.min(d.minX, f.minX)) * (Math
						.max(d.maxY, f.maxY) - Math.min(d.minY, f.minY)) - h) < u ? (u = l, c = h < c ?
						h : c, s = o) : l === u && h < c && (c = h, s = o);
				n = s || n.children[0]
			}
			return n
		},
		_insert: function(t, n, i) {
			...
			for (o.children.push(t), h(o, e); n >= 0 && r[n].children.length > this._maxEntries;) this
				._split(r, n), n--;
		...
		_split: function(t, n) {
			...
			s.height = i.height, s.leaf = i.leaf, o(i, this.toBBox), o(s, this.toBBox), n ? t[n - 1]
				.children.push(s) : this._splitRoot(i, s)
		},
		_splitRoot: function(t, n) {
			this.data = _([t, n]), this.data.height = t.height + 1, this.data.leaf = !1, o(this.data,
				this.toBBox)
		},
		_chooseSplitIndex: function(t, n, i) {
			var a, e, r, o, h, l, c, u, f, d, _, p, g, x;
			for (l = c = 1 / 0, a = n; a <= i - n; a++) e = s(t, 0, a, this.toBBox), r = s(t, a, i, this
					.toBBox), f = e, d = r, void 0, void 0, void 0, void 0, _ = Math.max(f.minX, d
				.minX), p = Math.max(f.minY, d.minY), g = Math.min(f.maxX, d.maxX), x = Math.min(f.maxY,
					d.maxY), o = Math.max(0, g - _) * Math.max(0, x - p), h = m(e) + m(r), o < l ? (l =
					o, u = a, c = h < c ? h : c) : o === l && h < c && (c = h, u = a);
			return u
		},
		...
		_condense: function(t) {
			for (var n, i = t.length - 1; i >= 0; i--) 0 === t[i].children.length ? i > 0 ? (n = t[i -
				1].children).splice(n.indexOf(t[i]), 1) : this.clear() : o(t[i], this.toBBox)
		},
		_initFormat: function(t) {
			var n = ["return a", " - b", ";"];
			this.compareMinX = new Function("a", "b", n.join(t[0])), this.compareMinY = new Function(
				"a", "b", n.join(t[1])), this.toBBox = new Function("a", "return {minX: a" + t[0] +
				", minY: a" + t[1] + ", maxX: a" + t[2] + ", maxY: a" + t[3] + "};")
		}
	}
}, function(t, n, i) {
	t.exports = function() {
		...
		return function(i, a, e, r, o) {
			! function n(i, a, e, r, o) {
				for (; r > e;) {
					...
					0 === o(i[e], d) ? t(i, e, p) : t(i, ++p, r), p <= a && (e = p + 1), a <= p && (r =
						p - 1)
				}
	...
	t.exports = function(t) {
		var n = (t.Layer ? t.Layer : t.Class).extend({
			...
			addLayer: function(t) {
				"markerPane" == t.options.pane && t.options.icon ? this.addMarker(t) : console
					.error("Layer isn't a marker")
			},
			...
			removeMarker: function(t, n) {
				...
				this._latlngMarkers.remove(e, function(t, n) {
					...
					}), this._latlngMarkers.total--, this._latlngMarkers.dirty++, !0 === a && !
					0 === n && this._redraw(!0)
			},
			onAdd: function(t) {
				this._map = t, this._canvas || this._initCanvas(), this.options.pane ? this
					.getPane().appendChild(this._canvas) : t._panes.overlayPane.appendChild(this
						._canvas), t.on("moveend", this._reset, this), t.on("resize", this
						._reset, this), t.on("click", this._executeListeners, this), t.on(
						"mousemove", this._executeListeners, this), t._zoomAnimated && t.on(
						"zoomanim", this._animateZoom, this)
			},
			onRemove: function(t) {
				this.options.pane ? this.getPane().removeChild(this._canvas) : t.getPanes()
					.overlayPane.removeChild(this._canvas), t.off("click", this
						._executeListeners, this), t.off("mousemove", this._executeListeners,
						this), t.off("moveend", this._reset, this), t.off("resize", this._reset,
						this), t._zoomAnimated && t.of("zoomanim", this._animateZoom, this)
			},
			addTo: function(t) {
			...
			_animateZoom: function(n) {
				var i = this._map.getZoomScale(n.zoom),
					a = this._map._latLngBoundsToNewLayerBounds(this._map.getBounds(), n.zoom, n
						.center).min;
				t.DomUtil.setTransform(this._canvas, a, i)
			},
			_addMarker: function(n, i, a) {
				n._map = this._map, this._markers || (this._markers = new rbush), this
					._latlngMarkers || (this._latlngMarkers = new rbush, this._latlngMarkers
						.dirty = 0, this._latlngMarkers.total = 0), t.Util.stamp(n);
				...
				return this._latlngMarkers.dirty++, this._latlngMarkers.total++, !0 === a &&
					this._drawMarker(n, e), h
			},
			_drawMarker: function(t, n) {
				var i = this;
				this._imageLookup || (this._imageLookup = {}), n || (n = i._map
					.latLngToContainerPoint(t.getLatLng()));
				var a = t.options.icon.options.iconUrl;
				if (t.canvas_img) i._drawImage(t, n);
				else if (i._imageLookup[a]) t.canvas_img = i._imageLookup[a][0], !1 === i
					._imageLookup[a][1] ? i._imageLookup[a][2].push([t, n]) : i._drawImage(t,
					n);
				else {
					var e = new Image;
					e.src = a, t.canvas_img = e, i._imageLookup[a] = [e, !1, [
						...
						i._imageLookup[a][1] = !0, i._imageLookup[a][2].forEach(function(
						t) {
			...
			_drawImage: function(t, n) {
				...
				this._context.drawImage(t.canvas_img, n.x - i.iconAnchor[0], n.y - i.iconAnchor[
					1], i.iconSize[0], i.iconSize[1])
			},
			_reset: function() {
			...
			_redraw: function(t) {
				...
				if (t && this._context.clearRect(0, 0, this._canvas.width, this._canvas.height),
					...
					var i = [];
					n._latlngMarkers.dirty / n._latlngMarkers.total >= .1 && (n._latlngMarkers
						.all().forEach(function(t) {
							i.push(t)
						}), n._latlngMarkers.clear(), n._latlngMarkers.load(i), n
						._latlngMarkers.dirty = 0, i = []);
			...
			_initCanvas: function() {
				this._canvas = t.DomUtil.create("canvas",
					"leaflet-canvas-icon-layer leaflet-layer");
				var n = this._map.getSize();
				this._canvas.width = n.x, this._canvas.height = n.y, this._context = this
			...
			_executeListeners: function(t) {
				if (this._markers) {
					...
					e && e.length > 0 ? (n._map._container.style.cursor = "pointer", "click" ===
						t.type && (e[0].data.getPopup() && e[0].data.openPopup(), n
							._onClickListeners.forEach(function(n) {
								n(t, e)
							})), "mousemove" === t.type && (e[0].data.getTooltip() && (n
								._openToolTip = e[0].data, e[0].data.openTooltip()), n
							._onHoverListeners.forEach(function(n) {
								n(t, e)
							}))) : n._map._container.style.cursor = ""
				}
			}
		});
		t.massmarkers = function(t) {
			return new n(t)
		}
	}
}]);
